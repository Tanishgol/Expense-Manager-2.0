...
export const Navbar = ({ activeTab, setActiveTab }) => {
    ...
    return (
        <nav
            className={`fixed w-full z-50 bg-gray-100 dark:bg-dark-card transition-all duration-300 ${isScrolled ? 'shadow-md' : ''}`}
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    <div
                        ...
                        className="font-bold text-indigo-600 dark:text-indigo-400 text-xl cursor-pointer hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors duration-200"
                    >
                        ExpenseTracker
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <ChevronDownIcon
                                    size={16}
                                    className={`hidden lg:block ml-1 text-gray-500 dark:text-gray-400 transition-transform duration-200 ${isProfileOpen ? 'rotate-180' : ''
                                        }`}
                                />
                            </button>

                            {isProfileOpen && (
                                <div className="absolute right-0 mt-2 w-48 lg:w-56 bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-md shadow-lg py-1 z-50">
                                    <button
                        ...
                        <button
                            ...
                            className="lg:hidden p-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-dark-border focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
            ...
            <div
                className={`lg:hidden mobile-menu transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'
