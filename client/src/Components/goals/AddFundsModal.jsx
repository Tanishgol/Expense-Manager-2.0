...
export const AddFundsModal = ({ isOpen, onClose, goal, onSubmit }) => {
    ...
    const handleSubmit = (e) => {
        ...
        onSubmit({
            ...goal,
            currentAmount: goal.currentAmount + newAmount,
            progress: ((goal.currentAmount + newAmount) / goal.targetAmount) * 100
        });
        onClose();
    };
